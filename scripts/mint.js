...
async function main() {
   const replace_contractAddress = "0x726aBA6BEa46F8B5A3Ccc867a393f372F9fC7C98";
   const [signer] = await hre.ethers.getSigners();
   const replace_contractFactory = await hre.ethers.getContractFactory("Bigplomaty");
   const contract = replace_contractFactory.attach(replace_contractAddress);
 
   const replace_functionName = "mint";
   const replace_functionArgs = ["0x3776d27959c202864e53Fccb41617F90a4108817","100000000000000000000"]; // 100 tokens with 18 decimal places
